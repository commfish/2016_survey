...
$$
MWbed_1 = \hat{N}\bar R\frac{\bar {RW}}{453.592}
$$
...
*MW* = meat weight, 
*RW* = round weight, and
453.592 = constant to convert weight from grams to pounds
...
A subsample of scallops were collected for more detailed biological data, a desired random subsample of 40 of which 10 (large only) were further sampled to determine a meat weight to round weight ratio. A goodness-of-fit test (K-S test) was performed for each tow to confirm that the 10 random samples were representative of the 40 subsampled.  Using only the tows that had adequate sampling of large scallops (n>11) the majority of the time these 10 samples represented the entire subsample well (90% of the time).  The small percentage of the time (10%) that these samples differed the overall sample size was small (i.e. n sampled was <20).  
